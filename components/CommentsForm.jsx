...
const CommentsForm = ({ slug }) => {
    ...
    return (
        <div className="bg-white shadow-lg rounded-lg p-8 pb-12 mb-8">
            <h3 className="text-2xl mb-8 font-semibold border-b pb-4 font-bubbles text-center">Leave a Reply to this post</h3>
            <div className="grid grid-cols-1 gap-4 mb-4">
                <textarea ref={commentEl} className="p-4 outline-none w-full rounded-lg focus:ring-2 focus:ring-gray-200 bg-gray-100 text-gray-700"
                    placeholder="Comments" name="comment" />
            </div>
            ...
            <div className="grid grid-cols-1 gap-4 mb-4">
                <div className="mt-2">
                    ...
                    <label className="text-gray-500 cursor-pointer ml-2" htmlFor="storeData">Save my e-mail and name for the next comment I make</label>
                </div>
            </div>
            {error && <p className="text-xs text-red-500">All fields are required</p>}
            <div className="mt-8">
                <button className="transition font-chakra duration-500 ease hover:bg-indigo-900 inline-block bg-red-600 text-xl rounded-full text-white px-8 py-3 cursor-pointer" 
